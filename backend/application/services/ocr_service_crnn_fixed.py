...
class OCRServiceWithCRNNFixed(OCRService):
    ...
    def __init__(self):
        ...
        self.e_penalty = float(os.getenv("CRNN_E_PENALTY", "0.95"))
        self.rdn_boost = float(os.getenv("CRNN_RDN_BOOST", "1.05"))
    ...
    def _load_crnn_model(self):
        ...
        try:
            ...
            if model_path.exists():
                ...
                from scripts.crnn_model import create_crnn_model, CTCLabelConverter
            ...
            for prefix, (pb, pnb) in beams.items():
                ...
                for c in range(1, num_classes):
                    ...
                    if self.confusion_tweaks:
                        if char == 'E' and self.e_penalty != 1.0:
                            bonus += float(np.log(max(self.e_penalty, 1e-6)))
                        elif char in {'R', 'D', 'N'} and self.rdn_boost != 1.0:
